...
public class BleAdvertiser {
        ...
        public void onCharacteristicReadRequest(BluetoothDevice device, int requestId, int offset,
            ...
            if (BandemicProfile.HASH_OF_UUID.equals(characteristic.getUuid())) {
                ...
                if (broadcastData == null) {
                    mBluetoothGattServer.sendResponse(device, requestId, BluetoothGatt.GATT_READ_NOT_PERMITTED, offset, new byte[0]);
                } else {
    ...
    public void startAdvertising() {
        ...
        AdvertiseData data = new AdvertiseData.Builder()
                .setIncludeTxPowerLevel(true) // TODO some devices don't know their tx power
