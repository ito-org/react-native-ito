...
public class Constants {
    ...
    public static final int TCN_VALID_INTERVAL = 1000 * 60 * 15; //ms * sec * 15 min
    ...
    public static final int RATCHET_EXCHANGE_INTERVAL = (4 * 24); // 1day? if beacon gets changed every 15min
}
